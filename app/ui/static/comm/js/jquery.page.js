	...
	var ms = {
		init: function(obj, args){
			return (function(){
				...
				// 转到指定页
				obj.append('<li class="disabled"><a href="javascript:" style="height:34px;">当前<input style="width:40px;height:20px;" type="text" value="'+args.pageNo+'" onkeydown="var e=e||event;var c=e.keyCode||e.which||e.charCode;if(c==13) '+args.pageFunc+'(this.value,'+args.pageSize+');" onclick="this.select();"/> / <input style="width:40px;height:20px;" type="text" value="'+args.pageSize+'" onkeydown="var e=e||event;var c=e.keyCode||e.which||e.charCode;if(c==13) '+args.pageFunc+'('+args.pageNo+',this.value);" onclick="this.select();"/>条，共'+args.totalElements+'条</a></li>');
			})();
		}
	}
