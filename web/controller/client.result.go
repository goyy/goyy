...
func (me *ClientController) SuccessMessage(c xhttp.Context, msg, state string) map[string]interface{} {
...
func (me *ClientController) FaultMessage(c xhttp.Context, msg, state string) map[string]interface{} {
