...
values ('admin', '{{message "tmpl.data.user.admin"}}', null, '92d55a4a6b07', '10', 'admin@goyy.org', null, null, 'root', 'root', -62135596800, -62135596800, 'admin', null, ` + now + `, null, null, null, ` + now + `, null, ` + now + `, 0, 0, 0, 0){{seperator}}
`
