...
var tmplNewProjAdmTemplatesSysArea = `<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta name="description" content="">
<meta name="author" content="">
<!--#settings project="sys" module="area" title="<%message "tmpl.sys.area.title"%>"--><!--#endsettings-->
...
<!--#include file="/core/comm/disable.html" param="{%.prefix%}"--><!--#endinclude-->
	<div class="tabbable">
		...
		<div class="tab-content">
			...
			<!--#include file="/core/comm/formtree.html" param="{%.prefix%}" input="parentId" url="/sys/area/tree"--><!--#endinclude-->
