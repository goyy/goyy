...
var (
	{{tname $e.Name $e.AllColumnMaxLen}} = schema.TABLE("{{lower $e.Table}}"){{if eq $e.Extend "pk"}}
	{{uncamel $e.Name|upper}}_{{cname "id" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.PRIMARY("id"){{else if eq $e.Extend "sys"}}
	{{uncamel $e.Name|upper}}_{{cname "id" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.PRIMARY("id")
	{{uncamel $e.Name|upper}}_{{cname "memo" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("memo")
	{{uncamel $e.Name|upper}}_{{cname "creates" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("creates")
	{{uncamel $e.Name|upper}}_{{cname "creater" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.CREATER("creater")
	{{uncamel $e.Name|upper}}_{{cname "created" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.CREATED("created")
	{{uncamel $e.Name|upper}}_{{cname "modifier" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.MODIFIER("modifier")
	{{uncamel $e.Name|upper}}_{{cname "modified" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.MODIFIED("modified")
	{{uncamel $e.Name|upper}}_{{cname "version" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.VERSION("version")
	{{uncamel $e.Name|upper}}_{{cname "deletion" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.DELETION("deletion")
	{{uncamel $e.Name|upper}}_{{cname "artifical" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("artifical")
	{{uncamel $e.Name|upper}}_{{cname "history" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("history"){{else if eq $e.Extend "tree"}}
	{{uncamel $e.Name|upper}}_{{cname "id" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.PRIMARY("id")
	{{uncamel $e.Name|upper}}_{{cname "code" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("code")
	{{uncamel $e.Name|upper}}_{{cname "name" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("name")
	{{uncamel $e.Name|upper}}_{{cname "fullname" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("fullname")
	{{uncamel $e.Name|upper}}_{{cname "genre" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("genre")
	{{uncamel $e.Name|upper}}_{{cname "leaf" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("leaf")
	{{uncamel $e.Name|upper}}_{{cname "grade" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("grade")
	{{uncamel $e.Name|upper}}_{{cname "ordinal" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("ordinal")
	{{uncamel $e.Name|upper}}_{{cname "parent_id" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("parent_id")
	{{uncamel $e.Name|upper}}_{{cname "parent_ids" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("parent_ids")
	{{uncamel $e.Name|upper}}_{{cname "parent_codes" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("parent_codes")
	{{uncamel $e.Name|upper}}_{{cname "parent_names" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("parent_names")
	{{uncamel $e.Name|upper}}_{{cname "memo" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("memo")
	{{uncamel $e.Name|upper}}_{{cname "creates" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("creates")
	{{uncamel $e.Name|upper}}_{{cname "creater" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.CREATER("creater")
	{{uncamel $e.Name|upper}}_{{cname "created" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.CREATED("created")
	...
	{{uncamel $e.Name|upper}}_{{cname "deletion" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.DELETION("deletion")
	{{uncamel $e.Name|upper}}_{{cname "artifical" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("artifical")
	{{uncamel $e.Name|upper}}_{{cname "history" $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("history"){{end}}{{range $f := $e.Fields}}{{if $f.IsPrimary}}
	{{uncamel $e.Name|upper}}_{{cname $f.Column $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.PRIMARY("{{lower $f.Column}}"){{else if $f.IsVersion}}
	{{uncamel $e.Name|upper}}_{{cname $f.Column $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.VERSION("{{lower $f.Column}}"){{else if $f.IsDeletion}}
	{{uncamel $e.Name|upper}}_{{cname $f.Column $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.DELETION("{{lower $f.Column}}"){{else if $f.IsCreater}}
	{{uncamel $e.Name|upper}}_{{cname $f.Column $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.CREATER("{{lower $f.Column}}"){{else if $f.IsCreated}}
	{{uncamel $e.Name|upper}}_{{cname $f.Column $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.CREATED("{{lower $f.Column}}"){{else if $f.IsModifier}}
	{{uncamel $e.Name|upper}}_{{cname $f.Column $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.MODIFIER("{{lower $f.Column}}"){{else if $f.IsModified}}
	{{uncamel $e.Name|upper}}_{{cname $f.Column $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.MODIFIED("{{lower $f.Column}}"){{else if $f.IsTransient}}
	{{uncamel $e.Name|upper}}_{{cname $f.Column $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.TRANSIENT("{{lower $f.Column}}"){{else}}
	{{uncamel $e.Name|upper}}_{{cname $f.Column $e.AllColumnMaxLen}} = {{uncamel $e.Name|upper}}.COLUMN("{{lower $f.Column}}"){{end}}{{end}}
)
