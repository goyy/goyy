...
var locales = map[string]map[string]string{
	i18n.LocaleZhCN: map[string]string{
		...
		"empty.environments.environment.sensitive": "environments.environment.sensitive[@name='%s']: 不允许为空！",
	...
	i18n.LocaleEnUS: map[string]string{
		...
		"empty.environments.environment.sensitive": "environments.environment.sensitive[@name='%s']: can not be empty!",
