...
type Service interface {
	...
	SelectCount(dql string, args map[string]interface{}) (int, error)
	...
	SelectFloatByNamed(dql string, args ...interface{}) (float64, error)
	SelectStrByNamed(dql string, args ...interface{}) (string, error)
